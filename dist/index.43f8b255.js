...
})({"1Pwfc":[function(require,module,exports) {
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "4e5dac8afe405db7";
module.bundle.HMR_BUNDLE_ID = "d200c70f43f8b255";
"use strict";
...
let pokemonRepository = function() {
    ...
    function addListItem(pokemon) {
        ...
        let button = $('<button class="pokemon-button btn btn-outline-danger btn-block btn-lg text-uppercase" data-toggle="modal" data-target="#pokemon-modal">' + pokemon.name + '</button>');
    ...
    function showDetails(pokemon) {
        loadDetails(pokemon).then(function() {
            ...
            let pokemonNameTitle = $('<h5 id="pokemon-name">' + pokemon.name.toUpperCase() + '</h5>');
    ...
    function searchPokemon(searchInput) {
        ...
        pokemonList.forEach((pokemon)=>{
            if (pokemon.name.toLowerCase().includes(searchInput.toLowerCase())) addListItem(pokemon);
        });
    }
...
//# sourceMappingURL=index.43f8b255.js.map
